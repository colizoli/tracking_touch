...
if subject_ID:
    ...
    stim_instr2a  = visual.TextStim(win, text=instr2_txt, color='black', pos=(0.0, 0.0), wrapWidth=ww)
    stim_instr2b  = visual.ImageStim(win, image=os.path.join('stimuli', 'trial.png'), size=(200,200), pos=(0.0, -100.0))
